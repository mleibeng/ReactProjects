...
It is VERY IMPORTANT THAT YOU Format your response in markdown to make it easier to render to a web page.
`;
...
export async function getRecipeFromMistral(ingredientsArr) {
    ...
    try {
        console.log("Fetching recipe with ingredients:", ingredientsString);
